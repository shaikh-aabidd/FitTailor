...
const Header = () => {
  ...
  const navItems = [
    ...
    { name: 'Products',to: '/products',   auth: 'both'       },
    { name: 'Customize',to: '/customize', auth: 'auth'       },
    { name: 'Cart',    to: '/cart',       auth: 'auth'       },
  ...
  return (
    <header className="bg-primary text-white shadow-md">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        {/* Logo */}
        <Link to="/" className="text-2xl font-bold">FitTailor</Link>
